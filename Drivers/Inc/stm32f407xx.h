...
typedef struct
{
    __vo uint32_t CR1;     /*!<TODO,                                      Adress offset: 0x00*/
    __vo uint32_t CR2;     /*!<TODO,                                      Adress offset: 0x04*/
    __vo uint32_t SR;      /*!<TODO,                                      Adress offset: 0x08*/
    __vo uint32_t DR;      /*!<TODO,                                      Adress offset: 0x0C*/
    __vo uint32_t CRCPR;   /*!<TODO,                                      Adress offset: 0x10*/
    __vo uint32_t RXCRCR;  /*!<TODO,                                      Adress offset: 0x14*/
    __vo uint32_t TXCRCR;  /*!<TODO,                                      Adress offset: 0x18*/
    __vo uint32_t I2SCFGR; /*!<TODO,                                      Adress offset: 0x1C*/
    __vo uint32_t I2SPR;   /*!<TODO,                                      Adress offset: 0x20*/
} SPI_RegDef_t;
typedef struct
{
